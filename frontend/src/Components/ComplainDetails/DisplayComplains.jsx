...
export default function DisplayComplains() {
    ...
    const displayNumberOfComplaints = () => {
        if (complains && complains.length > 0) {
            return (
                <p className="text-center mt-4">
                    Total number of complaints: {complains.length}
                </p>
            );
        } else {
            return null;
    ...
    return (
        <div>
            ...
            <h1 className='text-black font-bold text-[20px] text-center'>Complaints display page</h1>
